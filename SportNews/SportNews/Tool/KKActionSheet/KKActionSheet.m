...
- (instancetype)initWithTitle:(NSString *)title
    ...
    if (self) {
        ...
        if (cancelButtonTitle) {
            ...
            UIView *cancelView = [[UIView alloc] initWithFrame:CGRectMake(0, actionSheetH, MXAS_SCREEN_WIDTH, kRowHeight+xBottomHeight)];
            cancelView.backgroundColor = UIColor.whiteColor;
            
            UIButton *cancelButton = [UIButton buttonWithType:UIButtonTypeCustom];
            cancelButton.frame = CGRectMake(0, 0, MXAS_SCREEN_WIDTH, kRowHeight);
            cancelButton.tag = 0;
            ...
            actionSheetH = CGRectGetMaxY(cancelView.frame) + 0.5;
...
+ (void)showWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle   destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles selectedBlock:(void (^)(NSInteger index))selectedBlock {
    ...
    KKActionSheet *actionSheet = [[KKActionSheet alloc] initWithTitle:title cancelButtonTitle:cancelButtonTitle destructiveButtonTitle:destructiveButtonTitle otherButtonTitles:otherButtonTitles selectedBlock:selectedBlock];
