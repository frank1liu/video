//
//  BaseCategoryTableVC.m
//  SportNews
//
//  Created by pangchong on 2020/12/3.
//

#import "BaseCategoryTableVC.h"

@interface BaseCategoryTableVC ()<JXCategoryViewDelegate>

@end

@implementation BaseCategoryTableVC
...
- (void)viewDidLayoutSubviews {
    ...
    self.listContainerView.frame = CGRectMake(0, NavigationContentTop +  [self preferredCategoryViewHeight], self.view.bounds.size.width, self.view.bounds.size.height - TabBarHeight);
}
...
- (id<JXCategoryListContentViewDelegate>)listContainerView:(JXCategoryListContainerView *)listContainerView initListForIndex:(NSInteger)index {
    BaseGestureViewController *list = [[BaseGestureViewController alloc] init];
    return list;
}
