...
//  当天的显示具体时间，昨天显示Yesterday，一周内的显示星期几，一周后显示日期。
+ (NSString *_Nonnull)convertToNormalTimeWithDate:(NSDate *_Nonnull) date
                                 language:(NSDateNormalTimeLanguage) language;

//  当天的显示今天，昨天显示Yesterday，一周内的显示星期几，一周后显示日期。
+ (NSString *_Nullable)convertWithDate:(NSDate *_Nullable)date language:(NSDateNormalTimeLanguage) language;

//  时间格式
+ (NSString *_Nullable)convertToTimeWithDate:(NSDate *_Nullable)date language:(NSDateNormalTimeLanguage) language;

/// 获取日期
+ (NSString *_Nullable)timeStringWithInterval:(NSTimeInterval)timeInterval;
+ (NSString *_Nullable)timeStringWithInterval1:(NSTimeInterval)timeInterval;
