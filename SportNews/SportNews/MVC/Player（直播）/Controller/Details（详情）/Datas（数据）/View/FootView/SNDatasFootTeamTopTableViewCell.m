//
//  SNDatasFootTeamTopTableViewCell.m
//  SportNews
//
...
@interface SNDatasFootTeamTopTableViewCell ()
...
@implementation SNDatasFootTeamTopTableViewCell

 
#pragma mark -- initialization 初始化
+ (instancetype)cellWithTableView:(UITableView *)tableView {
    
    static NSString *ID = @"SNDatasFootTeamTopTableViewCell";
    SNDatasFootTeamTopTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[SNDatasFootTeamTopTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
    }
    return cell;
...
- (void)setupSubviews {
    ...
    [self.Label3 mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.equalTo(self.backView.mas_centerX).offset(-20);
    ...
    [self.Label7 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.Label1.mas_centerY);
        make.right.equalTo(self.backView).offset(-8.5);
    }];
    ...
    [self.Label5 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.Label1.mas_centerY);
        make.right.equalTo(self.Label6.mas_left).offset(-2);
