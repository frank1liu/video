...
//    [richText addComponent: nameComp];
    ...
    CGSize contentSize = [content boundingRectWithSize:CGSizeMake(kScreenWidth - 90, 1000) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:14]} context:nil].size;
...
+ (UIImage *) getMessageLevelImage:(NSInteger)level {
    switch (level) {
        case 0:
            return UIImageMake(@"level0bg");      // 游客
            break;
        case 1:
